...
class YAFA
{
    ...
    public function call_yafa($api_server, $site_name) {
        ...
        {
            throw new Exception("JSON syntax error, url: ".$api_server.$site_name);
        }
...
function yafa_cron() {
    try {
        ...
        mail("ops@gamer-network.net", "WP YAFA Plugin Cron Error", "Caught Exception During Cron - ".$e->getMessage());
        die();
    }
}
